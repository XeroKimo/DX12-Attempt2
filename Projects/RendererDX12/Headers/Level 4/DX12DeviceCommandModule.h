...
namespace RendererDX12
{
        ...
        {
        public:
            DX12DeviceCommandModule(LevelOne::BaseDevice* device, DX12ManagerCommandAllocator* manager, UINT directQueues, UINT computeQueues, UINT copyQueues);
            ...
            void StallQueue(D3D12_COMMAND_LIST_TYPE stallType, UINT stallIndex, LevelOne::Fence* fence, UINT64 fenceValue = FENCE_MAX_SIGNAL_VALUE);
            ...
            inline LevelOne::BaseDevice* GetDevice() { return m_device; }

        private:
            void StallQueue(DX12CommandQueue* queueToStall, LevelOne::Fence* fenceToWait, UINT64 valueToWait);
