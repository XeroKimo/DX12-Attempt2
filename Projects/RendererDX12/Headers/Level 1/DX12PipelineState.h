...
namespace RendererDX12
{
    ...
    {
    public:
        DX12PipelineState(ComPtr<ID3D12PipelineState> pipelineState, ComPtr<ID3D12RootSignature> rootSignature) { m_pipelineState = pipelineState; m_rootSignature = rootSignature; }
