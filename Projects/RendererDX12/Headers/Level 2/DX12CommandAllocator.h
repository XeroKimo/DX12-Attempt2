...
public:
	...
	void Initialize(ID3D12Device* device, const D3D12_COMMAND_LIST_TYPE& type, DX12ManagerCommandAllocator* commandAllocatorManager);
...
private:
	DX12ManagerCommandAllocator* m_commandAllocatorManager;
