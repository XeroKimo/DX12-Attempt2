...
namespace RendererDX12
{
    ...
    class DX12ManagerCommandAllocator;
        ...
        public:
            DX12CommandQueue(LevelOne::BaseDevice* device, D3D12_COMMAND_LIST_TYPE commandListType, DX12ManagerCommandAllocator* allocatorManager);
            ...
            void Reset();
            inline void StallQueue(LevelOne::Fence* fence, UINT64 fenceValue) { if (fenceValue <= fence->fenceValue) m_commandQueue.StallQueue(fence, fenceValue); }
            ...
            inline LevelOne::Fence* GetFence() { return m_commandQueue.GetFence(); }
        ...
        private:
            ...
            LevelTwo::DX12BaseCommandQueue m_commandQueue;
