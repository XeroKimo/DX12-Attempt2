...
namespace RendererDX12
{
    ...
    namespace LevelTwo
    {
        ...
        UINT64 DX12BaseCommandQueue::Signal(Fence* fence)
        {
            fence->fenceValue++;
        ...
        void DX12BaseCommandQueue::StallQueue(Fence* fence, UINT64 fenceValue)
        {
        ...
        void DX12BaseCommandQueue::SyncFence(DWORD milliseconds, Fence* fence, UINT64 fenceValue)
        {
